-- ============================================================
-- Migration Step 2 ONLY — run AFTER enum Step 1 is committed
-- Prerequisite: user_role already contains project_coordinator
--   and logistics_officer (verify with the SELECT enumlabel query).
